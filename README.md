...
先注册独立账号。用户名为3—30位字母、数字或下划线，密码至少10位；目前没有密码找回，请妥善保管。旧共享演示档案不会归入新账号。

「我 → 旅行回忆」支持文字、日期、地点与压缩照片的添加、草稿、编辑、删除和 PNG 下载。所有记录按服务端登录身份隔离，不发送给 AI。照片是压缩副本，不能代替原图备份。尚未实现多人共享与协作。
